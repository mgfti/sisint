...
<body>
  <div class="wrap">
    ...
    <div class="page-body">
      ...
      <div class="content">
      <?php render_content_header('Entrada e Saída de Militares Durante o Expediente', 'fa fa-suitecase'); ?>
              ...
              <div class="panel-content">
                <table id="responsive-table" class="tabela table table-striped table-hover responsive nowrap" width="100%">
                  ...
                  <tbody>
                    ...
                    $consulta_rel->bindParam(":situacao1", $situacao_entrada_militares, PDO::PARAM_STR);
                    $consulta_rel->bindParam(":situacao2", $situacao_saida_militares, PDO::PARAM_STR);
